...
- **Seleção de perfil (carrossel)** — a pessoa escolhe sua função e vê apenas o conteúdo, boas práticas e SAC daquela área.
- **SAC dinâmico por área**, com envio de novas perguntas (gera protocolo único) e uma **área de suporte com login**, onde a equipe responde e a resposta aparece automaticamente para quem perguntou. Veja `google-apps-script/CONFIGURAR-SAC.md` para configurar (usa uma Google Sheet como banco de dados, de graça).
