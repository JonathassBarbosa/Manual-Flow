...
(function(){
  ...
  const topbarRole = document.querySelector("#topbarRole");
  const topbarRoleName = document.querySelector("#topbarRoleName");
  ...
  function applyRole(role, opts){
    ...
    if (!showAll){
      ...
      if (topbarRoleName) topbarRoleName.textContent = label;
      if (topbarRole) topbarRole.style.display = "flex";
    } else if (topbarRole){
      topbarRole.style.display = "none";
    }
